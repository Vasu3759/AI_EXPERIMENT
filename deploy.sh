...
echo "1. Copy nginx-aipowered.conf to /etc/nginx/conf.d/aipowered.chalksnboard.in.conf"
echo "2. Test nginx configuration: sudo nginx -t"
echo "3. Reload nginx: sudo systemctl reload nginx"
echo "4. Generate SSL certificate: sudo certbot --nginx -d aipowered.chalksnboard.in"
